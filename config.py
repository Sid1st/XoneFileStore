...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002178186637"))
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002178186637'))
    ...
    if HAS_SSL:
        URL = "https://xoneapp-sid1st-0620d415.staging.koyeb.app/"
    else:
        URL = "https://xoneapp-sid1st-0620d415.staging.koyeb.app/"
